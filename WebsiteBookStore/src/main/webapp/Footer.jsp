			...
			<div class="row">
				<div class="col-lg-5 col-md-6 col-12">
					...
					<div class="single-footer about">
						...
						<p class="text">Very happy to serve you</p>
						<p class="call">
				...
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-footer social">
						...
						<div class="contact">
							<ul>
								<li>470 Đường Trần Đại Nghĩa, Khu đô thị, Ngũ Hành Sơn, Đà
									Nẵng 550000</li>
								<li>TRƯỜNG ĐH CNTT VÀ TT VIỆT HÀN</li>
								<li>ebookstore.final@gmail.com</li>
								<li>+0123 456 789</li>
							</ul>
						</div>
						<!-- End Single Widget -->
