						...
						<form class="form-signup" action="signup" method="post">
							...
							<div class="form-group last mb-3">
								<label for="password">Re-Password</label> <input type="password"
									name="repass" class="form-control" placeholder="re-password"
									id="password">
							</div>
							<div class="form-group last mb-3">
							...
							<div class="d-flex mb-5 align-items-center">
								<label class="control control--checkbox mb-0"><span
									class="caption" > Agree to the terms of use</span> <input
									type="checkbox" checked="checked" name="check" />
									<div class="control__indicator"></div> </label> <span class="ml-auto"><a
									href="login" class="forgot-pass">Back to login</a></span>
							</div>
